...
def main():
    ...
    shutil.copy('./scenario7_train_mask_single_sample.csv', pwd)
    shutil.copy('./scenario7_val_mask_single_sample.csv', pwd)
    shutil.copy('./scenario7_test_mask_single_sample.csv', pwd)
    ...
    train_dir = 'scenario7_train_mask_single_sample.csv'
    val_dir = 'scenario7_val_mask_single_sample.csv'
        ...
        for idx, n in enumerate(train_size):
            ...
            for epoch in range(num_epochs):
                ...
                if cur_accuracy > best_accuracy:
                    ...
                    net_name = checkpoint_directory  + '//' +  'LeNet5_64_beam'
    ...
    test_dir = './scenario7_test_mask_single_sample.csv'
    checkpoint_path = f'{checkpoint_directory}/LeNet5_64_beam'   
